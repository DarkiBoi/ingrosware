...
public class NametagsModule extends ToggleableModule {
    ...
    private Color getEntityColor(Entity entity) {
        return new Color(entity instanceof EntityPlayer && IngrosWare.INSTANCE.getFriendManager().isFriend(((EntityPlayer)entity).getGameProfile().getId()) ? 0xff2020ff : (entity.isSneaking() ? 0xffffff00 : playerColor.getRGB()));
    }
}
