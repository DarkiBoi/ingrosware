 ...
 * @since 6/14/2020
 **/
@Toggleable(label = "Sprint11", category = ModuleCategory.MOVEMENT,color = 0xff72B190,bind = Keyboard.KEY_NONE)
public class Sprint11Module extends ToggleableModule {
