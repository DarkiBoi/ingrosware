package best.reich.ingrosware.font;
 ...
 * made by Hal
 **/
public class MCFontRenderer extends CFont implements Labelable {
    ...
    public MCFontRenderer(String label, Font font, boolean antiAlias, boolean fractionalMetrics)
    {
